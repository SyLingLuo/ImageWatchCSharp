...
namespace ImageWatchCSharp.ToolWindow
{
    ...
    internal sealed class MainToolWindowCommand
    {
        ...
        /// </summary>
        public static readonly Guid CommandSet = new Guid("f0c82bf1-a4c0-4faf-a9eb-9c2d5a837bc2");
        ...
        private async void Execute(object sender, EventArgs e)
        {
            ...
            await this.package.JoinableTaskFactory.RunAsync(async delegate
              {
                  ToolWindowPane window = await this.package.ShowToolWindowAsync(typeof(MainToolWindow), 0, true, this.package.DisposalToken);
